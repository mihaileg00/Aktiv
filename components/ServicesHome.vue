        ...
        return {
                    services: [
                        ...
                        },
                        {
                            ...
                            description: "Нашето тримесечно счетоводно обслужване осигурява комплексно обслужване и консултации, които помагат на вашето предприятие да поддържа финансите си в ред и да се съобразява със законовите изисквания.",
                            icon: "/icons/Time.svg",
                            img: "/photos/photo3.webp",
