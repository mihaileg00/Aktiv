    ...
    <main>
            ...
            <div id="description" class="animate__animated" :class="elements[1].observed ? elements[1].animationClasses:'opacity-0' ">
                <div id="description-header">
                        <h2 class="display-8 extra-bold color-primary display-7-mobile">{{text.description.title}}</h2>
                        <div class="spacer-24"></div>
                        <p class="paragraph-large color-secondary">{{ text.description.text }}</p>
                </div>
                <div class="spacer-32 spacer-48-mobile"></div>
                    <ul class="services" >
                        <li class="service-bullet shadow-02" v-for="service in text.description.bullets" :key="service">
                            <NuxtImg  :src="`/icons/light/${service.iconName}.svg`" width="48px" height="48px" fit="cover" :alt="`${service.iconName} Icon`" />
...
useHead(() => {
  ...
  { id: 'description-header', observed: false, animationClasses: 'animate__fadeInUp animate_faster' },
  { id: 'call-to-action', observed: false, animationClasses: 'animate__fadeInUp animate_faster'}
